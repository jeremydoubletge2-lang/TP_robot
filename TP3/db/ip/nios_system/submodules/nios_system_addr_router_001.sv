...
(
    ...
    localparam PAD5 = log2ceil(64'h4003010 - 64'h4003000); 
    localparam PAD6 = log2ceil(64'h4003020 - 64'h4003010); 
    localparam PAD7 = log2ceil(64'h4003028 - 64'h4003020); 
    // -------------------------------------------------------
    ...
    // ( 0x4003010 .. 0x4003020 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 27'h4003010   ) begin
            src_channel = 8'b00001000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x4003020 .. 0x4003028 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 27'h4003020   ) begin
